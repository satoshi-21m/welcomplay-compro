...
import { PortfolioCreateFormState } from "@/hooks/usePortfolioCreateForm"

interface PortfolioCreateFormProps {
  formState: PortfolioCreateFormState
  onFieldChange: (field: keyof PortfolioCreateFormState, value: any) => void
    ...
    <div className="space-y-4 p-2 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <p className="text-gray-600 text-left">Buat portfolio yang menarik untuk showcase proyek Anda</p>
        </div>
      ...
      <div className="portfolio-form space-y-4">
        {/* Main Content */}
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-4">
            <PortfolioBasicInfo
              ...
              onInputChange={(field, value) => onFieldChange(field, value)}
