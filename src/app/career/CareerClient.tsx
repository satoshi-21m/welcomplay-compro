...
export function CareerClient({ careerData }: CareerClientProps) {
  ...
  return (
    <div className="bg-[#f5f6f7]">
      ...
      <div className="text-center mb-12">
        ...
        Bergabunglah dengan PT LAB WELCOM PLAY dan kembangkan karir Anda di dunia teknologi.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-custom-red focus:border-transparent transition-all duration-300"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-custom-red focus:border-transparent appearance-none bg-white cursor-pointer"
            >
      ...
      <div className="space-y-6">
        {filteredJobs.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">Tidak ada posisi yang ditemukan</h3>
            <p className="text-gray-500">Coba ubah filter atau keyword pencarian Anda</p>
          </div>
        )}
      </div>
    </div>
...
// Export default untuk mengatasi masalah import
